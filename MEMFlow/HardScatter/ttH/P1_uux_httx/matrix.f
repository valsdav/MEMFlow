...
C     
C     Process: u u~ > h t t~ WEIGHTED<=4 @1
C     Process: c c~ > h t t~ WEIGHTED<=4 @1
C     Process: d d~ > h t t~ WEIGHTED<=4 @1
C     Process: s s~ > h t t~ WEIGHTED<=4 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFS4_1(W(1,4),W(1,3),GC_94,MDL_MT,MDL_WT,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,5),W(1,2),W(1,6),GC_11,AMP(1))
      CALL FFS4_2(W(1,5),W(1,3),GC_94,MDL_MT,MDL_WT,W(1,2))
