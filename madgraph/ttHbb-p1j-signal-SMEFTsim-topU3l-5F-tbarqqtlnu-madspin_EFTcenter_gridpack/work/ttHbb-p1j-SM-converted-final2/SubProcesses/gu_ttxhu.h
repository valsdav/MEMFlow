...
#ifndef MG5_Sigma_sm_gu_ttxhu_H
#define MG5_Sigma_sm_gu_ttxhu_H
...
class gu_ttxhu : public ProcessClass
{
  public:
    ...
    virtual string name() const {return "g u > t t~ h u (sm)";}
