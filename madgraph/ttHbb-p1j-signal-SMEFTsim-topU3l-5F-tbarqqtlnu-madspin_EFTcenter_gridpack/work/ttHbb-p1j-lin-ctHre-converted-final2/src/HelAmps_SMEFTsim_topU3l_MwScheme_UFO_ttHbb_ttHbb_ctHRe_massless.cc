    ...
    std::complex<double> COUP, double M3, double W3, std::complex<double> V3[])
{
  ...
  denom = COUP/((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  V3[2] = denom * (-cI) * (F1[2] * F2[4] + F1[3] * F2[5] + F1[4] * F2[2] +
      F1[5] * F2[3] - P3[0] * OM3 * TMP3);
  V3[3] = denom * (-cI) * (-F1[2] * F2[5] - F1[3] * F2[4] - P3[1] * OM3 * TMP3
      + F1[4] * F2[3] + F1[5] * F2[2]);
  V3[4] = denom * (-cI) * (-cI * (F1[2] * F2[5] + F1[5] * F2[2]) + cI * (F1[3]
      * F2[4] + F1[4] * F2[3]) - P3[2] * OM3 * TMP3);
  V3[5] = denom * (-cI) * (-F1[2] * F2[4] - F1[5] * F2[3] - P3[3] * OM3 * TMP3
      + F1[3] * F2[5] + F1[4] * F2[2]);
}
    ...
    std::complex<double> COUP, double M3, double W3, std::complex<double> V3[])
{
  ...
  denom = COUP/((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  V3[2] = denom * (-cI) * (F1[2] * F2[4] + F1[3] * F2[5] - P3[0] * OM3 * TMP5); 
  V3[3] = denom * (-cI) * (-F1[2] * F2[5] - F1[3] * F2[4] - P3[1] * OM3 *
      TMP5);
  V3[4] = denom * (-cI) * (-cI * (F1[2] * F2[5]) + cI * (F1[3] * F2[4]) - P3[2]
      * OM3 * TMP5);
  V3[5] = denom * (-cI) * (-F1[2] * F2[4] - P3[3] * OM3 * TMP5 + F1[3] *
      F2[5]);
}
    ...
    std::complex<double> V1[])
{
  ...
  P1[3] = -V1[0].imag(); 
  TMP1 = (V4[2] * V3[2] - V4[3] * V3[3] - V4[4] * V3[4] - V4[5] * V3[5]); 
  TMP6 = (V4[2] * V2[2] - V4[3] * V2[3] - V4[4] * V2[4] - V4[5] * V2[5]); 
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[2] = denom * (-cI * (V3[2] * TMP6) + cI * (V2[2] * TMP1)); 
  V1[3] = denom * (-cI * (V3[3] * TMP6) + cI * (V2[3] * TMP1)); 
  V1[4] = denom * (-cI * (V3[4] * TMP6) + cI * (V2[4] * TMP1)); 
  V1[5] = denom * (-cI * (V3[5] * TMP6) + cI * (V2[5] * TMP1)); 
}
    ...
    & vertex)
{
  ...
  TMP7 = (F1[2] * F2[2] + F1[3] * F2[3] + F1[4] * F2[4] + F1[5] * F2[5]); 
    ...
    std::complex<double> COUP, double M1, double W1, std::complex<double> V1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[2] = denom * (TMP0 * (-cI * (P2[0]) + cI * (P3[0])) + (V2[2] * (-cI *
      (TMP8) + cI * (TMP9)) + V3[2] * (+cI * (TMP10) - cI * (TMP11))));
  V1[3] = denom * (TMP0 * (-cI * (P2[1]) + cI * (P3[1])) + (V2[3] * (-cI *
      (TMP8) + cI * (TMP9)) + V3[3] * (+cI * (TMP10) - cI * (TMP11))));
  V1[4] = denom * (TMP0 * (-cI * (P2[2]) + cI * (P3[2])) + (V2[4] * (-cI *
      (TMP8) + cI * (TMP9)) + V3[4] * (+cI * (TMP10) - cI * (TMP11))));
  V1[5] = denom * (TMP0 * (-cI * (P2[3]) + cI * (P3[3])) + (V2[5] * (-cI *
      (TMP8) + cI * (TMP9)) + V3[5] * (+cI * (TMP10) - cI * (TMP11))));
}
    ...
    std::complex<double> V1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[2] = denom * (-cI * (V4[2] * TMP0) + cI * (V3[2] * TMP6)); 
  V1[3] = denom * (-cI * (V4[3] * TMP0) + cI * (V3[3] * TMP6)); 
  V1[4] = denom * (-cI * (V4[4] * TMP0) + cI * (V3[4] * TMP6)); 
  V1[5] = denom * (-cI * (V4[5] * TMP0) + cI * (V3[5] * TMP6)); 
}
...
}  // end namespace $(namespace)s_SMEFTsim_topU3l_MwScheme_UFO_ttHbb_ttHbb_ctHRe_massless
