...
def train(validation_dataset, device, config, dtype, path_to_model,
    ...
    for i, data_batch in enumerate(testDataset):
        ...
        with torch.no_grad():
            ...
            #print(logScaled_reco_sortedBySpanet.shape)
            ...
            fullGeneratedEvent = sample_fullRecoEvent_classifier_v2(model, logScaled_partons, logScaled_reco_sortedBySpanet.shape[0], device,
