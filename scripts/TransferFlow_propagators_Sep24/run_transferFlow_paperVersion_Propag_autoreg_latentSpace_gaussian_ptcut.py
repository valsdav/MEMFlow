...
def train( device, name_dir, config,  outputDir, dtype,
    ...
    if device == 0 or world_size is None:
        ...
        exp.set_name(f"TransferFlow_gaussian_ptcut_OnlyPropagators_{randint(0, 1000)}")
    else:
        exp = None
