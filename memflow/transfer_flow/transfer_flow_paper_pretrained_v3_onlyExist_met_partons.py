...
class TransferFlow_Paper_pretrained_v3_onlyExist_MET_partons(nn.Module):
    def __init__(self,
        ...
        super(TransferFlow_Paper_pretrained_v3_onlyExist_MET_partons, self).__init__()
        ...
        # flow for lepton
        self.flow_kinematics_lepton = zuko.flows.NSF(features=flow_nfeatures,
        ...
        # flow for jets
        self.flow_kinematics_jets = zuko.flows.NSF(features=flow_nfeatures,
                              context=transformer_input_features + 1, # additional position of 'jet'
