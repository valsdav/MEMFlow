...
class TransferFlow_Paper_AllPartons_Nobtag_autoreg_latentSpace_gaussian(nn.Module):
    def __init__(self,
        ...
        super(TransferFlow_Paper_AllPartons_Nobtag_autoreg_latentSpace_gaussian, self).__init__()
