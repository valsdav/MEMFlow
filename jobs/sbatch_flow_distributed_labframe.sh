...
apptainer exec  --nv -B /work/dvalsecc -B `pwd` /cvmfs/unpacked.cern.ch/gitlab-registry.cern.ch/dvalsecc/memflow:latest bash /work/dvalsecc/MEM/MEMFlow/jobs/script_flow_labframe_logit.sh $1 $2
